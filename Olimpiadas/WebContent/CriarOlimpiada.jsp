...
<body>
    ...
    <div id="main" class="container">
        <h3 class="page-header">Incluir Olimpiada</h3>
        ...
        <form action="controller.do" method="post">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="tipo" id="tipo" required maxlength="100" placeholder="Tipo">
                </div>
            </div>
            <hr />
