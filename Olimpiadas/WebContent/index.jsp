...
required maxlength="100" placeholder="Obrigatório">

</div>
<div class="form-group col-md-6">
<label for="populacao">População</label>
<input type="number" class="form-control" name="populacao" id="populacao"

required maxlength="60" placeholder="Obrigatório">
